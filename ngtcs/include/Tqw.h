...
**
** Version:
**    $Id: Tqw.h,v 0.2 2001/12/13 13:48:13 mjf Exp $
**
** History:
**    $Log: Tqw.h,v $
...
#define MAIN_PROC_NAME                 "E_TTL_AZN_TtlProcess"
...
ProcessName_t  ProcessNameTable [PROCESS_NAME_TABLE_MAX_SIZE] = {
   ...
   { INC, E_INC_REG_SERVER_NAME, E_INC_SERVER_PROC, E_INC_SERVER_PATH, E_INC_SERVER_PRI},     /* Inclinometer              12 */
   { SIF, E_SIF_REG_SERVER_NAME, E_SIF_SERVER_PROC, E_SIF_SERVER_PATH, E_SIF_SERVER_PRI},     /* Support Interface         13 */
   { CFL, E_CFL_REG_SERVER_NAME, E_CFL_SERVER_PROC, E_CFL_SERVER_PATH, E_CFL_SERVER_PRI},     /* Configureable Fast Logger 14 */
   { CAN, E_CAN_REG_SERVER_NAME, E_CAN_SERVER_PROC, E_CAN_SERVER_PATH, E_CAN_SERVER_PRI},     /* CAN BUS                   15 */
   { AMS, E_AMS_REG_SERVER_NAME, E_AMS_SERVER_PROC, E_AMS_SERVER_PATH, E_AMS_SERVER_PRI},     /* Aux Mech. State Control   16 */
   { ACM, E_ACM_REG_SERVER_NAME, E_ACM_SERVER_PROC, E_ACM_SERVER_PATH, E_ACM_SERVER_PRI},     /* ACADS                     17 */

   { ASC, E_ASC_REG_SERVER_NAME, E_ASC_SERVER_PROC, E_ASC_SERVER_PATH, E_ASC_SERVER_PRI},     /* Axis Stop Controller      18 */
   { PMS, E_PMS_REG_SERVER_NAME, E_PMS_SERVER_PROC, E_PMS_SERVER_PATH, E_PMS_SERVER_PRI},     /* Mirror Support State Ctrl 19 */
   { MBS, E_MBS_REG_SERVER_NAME, E_MBS_SERVER_PROC, E_MBS_SERVER_PATH, E_MBS_SERVER_PRI},     /* MODbus Server             20 */
   {   0,                     0,                 0,                 0, 0},                    /*                           21 */
   {   0,                     0,                 0,                 0, 0},                    /*                           22 */
   {   0,                     0,                 0,                 0, 0},                    /*                           23 */
   {   0,                     0,                 0,                 0, 0}                     /*                           24 */
...
extern Status_t   eTTL_Name_Attach (char     *ProcName, 
                                    Int32_t  *NameId) ;
                             
extern Status_t   eTTL_Name_Detach (Int32_t  NameId) ;

extern Status_t   eTTL_Name_Locate (char   *ProcName,
                                    pid_t  *FoundPid) ;
...
Status_t   eTTL_Receive (pid_t   ExpRecPid) ;

Status_t   eTTL_Send (pid_t    DestPid, 
                      void     *ReplyMsgPtr,
                      Int32_t  ReplyMsgSize) ;

Status_t   eTTL_Reply (pid_t   ReplyPid) ;
