...
**
** Version:
**    $Id: Amc.h,v 0.30 2002/04/26 16:06:57 djm Exp $
**
** History:
**    $Log: Amc.h,v $
...
#define E_AMC_REG_SERVER_NAME   "E_TTL_AMC_Amc"
#define E_AMC_SERVER_PROC       "Amc"
#define E_AMC_SERVER_PATH       "//1/opt/ttl/bin/Amc"
#define E_AMC_SERVER_PRI        28
