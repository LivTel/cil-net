...
**
** Version:
**    $Id: Mif.h,v 0.18 2001/11/29 11:27:13 mjf Exp $
**
** History:
**    $Log: Mif.h,v $
...
typedef enum eMifDataId_e{
    ...
    D_MIF_INPUT_BIT_BASE,               /* Base for digital input bits */           /* 0030 */
...
#define E_MIF_REG_SERVER_NAME   "E_TTL_MIF_Mif"
#define E_MIF_SERVER_PROC       "Mif"
#define E_MIF_SERVER_PATH       "//1/opt/ttl/bin/Mif"
#define E_MIF_SERVER_PRI        29
