  ...
  implements java.io.Serializable, ngat.ngtcs.subsystem.TTL_DataType
{
  ...
  public final static SFD_State E_SFD_STATE_DISABLED =
      new SFD_State( "E_SFD_STATE_DISABLED", 0, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_State E_SFD_STATE_ENABLED =
      new SFD_State( "E_SFD_STATE_ENABLED", 1, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_State E_SFD_STATE_HOMING =
      new SFD_State( "E_SFD_STATE_HOMING", 2, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_State E_SFD_STATE_READY =
      new SFD_State( "E_SFD_STATE_READY", 3, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_State E_SFD_STATE_MOVING =
      new SFD_State( "E_SFD_STATE_MOVING", 4, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_State E_SFD_STATE_ERROR =
      new SFD_State( "E_SFD_STATE_ERROR", 5, TTL_Package.E_SFD );
