...
**
** Version:
**    $Id: Nmc.h,v 0.9 2002/03/06 17:14:48 djm Exp $
**
** History:
**    $Log: Nmc.h,v $
...
#define E_NMC_REG_SERVER_NAME   "E_TTL_NMC_Nmc"
#define E_NMC_SERVER_PROC       "Nmc"
#define E_NMC_SERVER_PATH       "//1/opt/ttl/bin/Nmc"
#define E_NMC_SERVER_PRI        10
