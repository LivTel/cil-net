...
**
** Version:
**    $Id: Tfp.h,v 0.17 2001/11/29 13:07:18 djm Exp $
**
** History:
**    $Log: Tfp.h,v $
...
#include <sys/irqinfo.h>                    /* Definition for pid_t */
...
#define E_TFP_REG_SERVER_NAME   "E_TTL_TFP_Tfp"
#define E_TFP_SERVER_PROC       "Tfp"
#define E_TFP_SERVER_PATH       "//1/opt/ttl/bin/Tfp"
#define E_TFP_SERVER_PRI        10
...
typedef enum{
    ...
    E_TFP_PULSE_CODE_MODULATION_DCLS    = 0x49
...
Status_t    eTfpConnectInterruptHandler(pid_t (far *Handler)(void), unsigned DataSegment);
