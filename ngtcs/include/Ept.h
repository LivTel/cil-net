...
**
** Version:
**    $Id: Ept.h,v 0.45 2002/01/09 15:20:37 mjf Exp $
**
** History:
**    $Log: Ept.h,v $
...
typedef enum eEptDataState_e
{
   ...
   */
   ...
   E_EPT_SPR1_STATE,    /* Spare state 1 */
...
typedef enum eEptDataId_e
{
   ...
   */
   ...
   D_EPT_HYD_PMP_UNAVAIL , /* Hydraulic Pump Not Available */
   ...
   D_EPT_HTK_LVL_UNAVAIL , /* Hydraulic Tank Level Not Available */
   D_EPT_HTK_TEMP        , /* Hydraulic Tank Temperature State */
   D_EPT_HTK_TEMP_FAULT  , /* Hydraulic Tank Temperature Fault */
   D_EPT_HTK_TEMP_UNAVAIL, /* Hydraulic Tank Temperature Not Available */
   D_EPT_SHA_PRES        , /* Shutters Accumulator Pressure State */        
   D_EPT_SHA_PRES_FAULT  , /* Shutters Accumulator Pressure Fault */        
   D_EPT_SHA_PRES_UNAVAIL, /* Shutters Accumulator Pressure Not Available */
   D_EPT_LKA_PRES        , /* Locks Accumulator Pressure State */        
   D_EPT_LKA_PRES_FAULT  , /* Locks Accumulator Pressure Fault */        
   D_EPT_LKA_PRES_UNAVAIL, /* Locks Accumulator Pressure Not Available */
   D_EPT_MSV             , /* Maintenance Safety Valve State */        
   D_EPT_MSV_FAULT       , /* Maintenance Safety Valve Fault */        
   D_EPT_MSV_UNAVAIL     , /* Maintenance Safety Valve Not Available */
   D_EPT_FLT1            , /* Filter 1 Pressure Switch State */        
   D_EPT_FLT1_FAULT      , /* Filter 1 Pressure Switch Fault */        
   D_EPT_FLT1_UNAVAIL    , /* Filter 1 Pressure Switch Not Available */
   D_EPT_FLT2            , /* Filter 2 Pressure Switch State */        
   D_EPT_FLT2_FAULT      , /* Filter 2 Pressure Switch Fault */        
   D_EPT_FLT2_UNAVAIL    , /* Filter 2 Pressure Switch Not Available */
   D_EPT_UPS             , /* Enclosure UPS  */
   D_EPT_CLS_ACC_FLT     , /* Fault Closing Enclosure under Accumulator Power */
   D_EPT_OHTG            , /* Oil Tank Heating State */
   D_EPT_OHTG_FAULT      , /* Oil Tank Heating Fault */
   D_EPT_OHTG_UNAVAIL    , /* Oil Tank Heating Not Available */
   D_EPT_MCBS            , /* Miniature Circuit Breakers State */
   D_EPT_MCBS_FAULT      , /* Miniature Circuit Breakers Fault */
   D_EPT_MCBS_UNAVAIL    , /* Miniature Circuit Breakers Not Available */
   D_EPT_ESTOP           , /* Enclosure Emergency Stop  */
   D_EPT_ACC             , /* Accumulator State */
   ...
   D_EPT_PLC_SHUTDOWN    , /* E PLC requests immediate shutdown (not used) */
   ...
   D_EPT_DC_PMP_UNAVAIL , /* Backup DC Pump Not Available */
   ...
   D_EPT_FLT_PMP_UNAVAIL, /* Off-Line Filter Pump Not Available */
   ...
   D_EPT_OHTG_1_UNAVAIL , /* Oil Tank Heater 1 Not Available */
   D_EPT_OHTG_2         , /* Oil Tank Heater 2 State */
   D_EPT_OHTG_2_FAULT   , /* Oil Tank Heater 2 Fault */
   D_EPT_OHTG_2_UNAVAIL , /* Oil Tank Heater 2 Not Available */
   ...
   /* IUCAA-only data */
   D_EPT_DOME_STATE     , /* Dome azimuth angle in milli-arc secconds. */
   D_EPT_AZM_POS        , /* Dome azimuth angle in milli-arc secconds. */
   D_EPT_ALT_POS        , /* Dome altitude angle in milli-arc secconds. */
   ...
   */
   D_EPT_DMD_AP_STATE   , /* Aperture   */
   D_EPT_DMD_S1_STATE   , /* Shutter 1  */
   D_EPT_DMD_S2_STATE   , /* Shutter 2  */
   D_EPT_DMD_AP_POS     , /* Aperture Required Position Value  */
   D_EPT_DMD_S1_POS     , /* Shutter 1 Required Position Value */
   D_EPT_DMD_S2_POS     , /* Shutter 2 Required Position Value */
   D_EPT_DMD_HALT       , /* Halt Motion */
   D_EPT_DMD_STOP       , /* Stop Motion, only accept commands when FALSE. */
   ...
   /* IUCAA only datums. */
   D_EPT_DMD_DOME_AZM   , /* Demanded dome azimuth angle in milli-arc secs. */
   D_EPT_DMD_DOME_ALT   , /* Demanded dome altitude angle in milli-arc secs. */
