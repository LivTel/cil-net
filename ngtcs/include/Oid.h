...
**
** Version:
**    $Id: Oid.h,v 0.28 2001/09/24 08:58:25 mjf Exp $
**
** History:
**    $Log: Oid.h,v $
...
#define E_ACN_MAX_NUM_OF_AGENTS     64
#define E_MAX_OID                   20
...
typedef  struct
{
    Bool_t   LoadCommsIn ;        /* flag to control loading of Comms In      */
    Bool_t   LoadCommsOut ;       /* flag to control loading of Comms Out	*/
    Bool_t   LoadHBAgent ;        /* flag to control loading of HBeat Agent   */
    Bool_t   LoadGetValAgt ;      /* flag to control loading of Get Value Agt */
    Bool_t   LoadSetValAgt ;      /* flag to control loading of Set Value Agt */
    Bool_t   LoadGetAttrAgt ;     /* flag to control loading of Get Attr Agt  */
    Bool_t   LoadSetAttrAgt ;     /* flag to control loading of Set Attr Agt  */
	 Bool_t   LoadTrackAgt;        /* flag to control loading of Track Agent	*/
    Bool_t   NodeStateCont ;      /* flag to control loading of Node State Cont */
	 Bool_t   LoadPollSafeAgt ;    /* flag to control loading of PollSafe Agent */
	 Bool_t   LoadPollActiveAgt ;  /* flag to control loading of PollActive Agent */
    Int32_t  NumHBAgts ;          /* number of HBeat Agents to load	*/
    Int32_t  NumGetValAgts ;      /* number of Get Value Agents to load       */
    Int32_t  NumSetValAgts ;      /* number of Set Value Agents to load       */
    Int32_t  NumGetAttrAgts ;     /* number of Get Attr Agents to load	*/
    Int32_t  NumSetAttrAgts ;     /* number of Set Attr Agents to load	*/
    Int32_t  NumTrackAgts ;       /* number of Track Agents to load	*/
    Int32_t  NumPollSafeAgts ;
    Int32_t  NumPollActiveAgts ;
    Int32_t  ActHBAgts ;          /* actual number of HBeat Agents to load	*/
    Int32_t  ActGetValAgts ;      /* actual number of Get Value Agents loaded */
    Int32_t  ActSetValAgts ;      /* actual number of Set Value Agents loaded */
    Int32_t  ActGetAttrAgts ;     /* actual number of Get Attr Agents loaded	*/
    Int32_t  ActSetAttrAgts ;     /* actual number of Set Attr Agents loaded	*/
    Int32_t  ActTrackAgts ;       /* actual number of Track Agents loaded     */
	 Int32_t  ActPollSafeAgts ;
	 Int32_t  ActPollActiveAgts ;
} AuxProcDets_t ;
...
extern Status_t iAcnProcessResponse (eGenACNMsg_t  *pMsg,
                                     pid_t         AgentPid,
                                     pid_t         *ClientPidPtr) ;
					                                                        
extern Status_t iAcnProcessRequest (eGenACNMsg_t  *pMsg,
                                    pid_t         ClientPid,
                                    Int32_t       nAgentType) ;

extern eNameServStatus_t iAcnForwardResultToClient (eGenACNMsg_t  *pResMsg,
                                                    pid_t         ClientPid) ;
                                             
extern eNameServStatus_t iAcnReportRequestError (eGenACNMsg_t  *pAgentMsg,
                                                 pid_t         ClientPid,
                                                 Int32_t       ErrorNum) ;
                                          
extern eNameServStatus_t iAcnForwardRequestToAgent (eGenACNMsg_t  *pClientMsg,
                                                    pid_t         AgentPid,
                                                    char          *ProcName) ;
                                                    
static void iAcnSignalHandler (int SigNum) ;
...
extern Status_t  GeneratePollMessage (eGenACNMsg_t  *MessageInPtr,
                                      eGenACNMsg_t  *PollMsgPtr) ;
