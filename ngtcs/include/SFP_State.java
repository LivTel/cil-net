  ...
  implements java.io.Serializable, ngat.ngtcs.subsystem.TTL_DataType
{
  ...
  public final static SFP_State E_SFP_STATE_DISABLED =
      new SFP_State( "E_SFP_STATE_DISABLED", 0, TTL_Package.E_SFP );

  /**
   * 
   */
  public final static SFP_State E_SFP_STATE_ENABLED =
      new SFP_State( "E_SFP_STATE_ENABLED", 1, TTL_Package.E_SFP );

  /**
   * 
   */
  public final static SFP_State E_SFP_STATE_HOMING =
      new SFP_State( "E_SFP_STATE_HOMING", 2, TTL_Package.E_SFP );

  /**
   * 
   */
  public final static SFP_State E_SFP_STATE_READY =
      new SFP_State( "E_SFP_STATE_READY", 3, TTL_Package.E_SFP );

  /**
   * 
   */
  public final static SFP_State E_SFP_STATE_MOVING =
      new SFP_State( "E_SFP_STATE_MOVING", 4, TTL_Package.E_SFP );

  /**
   * 
   */
  public final static SFP_State E_SFP_STATE_ERROR =
      new SFP_State( "E_SFP_STATE_ERROR", 5, TTL_Package.E_SFP );
