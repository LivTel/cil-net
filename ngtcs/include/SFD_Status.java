  ...
  implements java.io.Serializable, ngat.ngtcs.subsystem.TTL_DataType
{
  ...
  public final static SFD_Status E_SFD_GEN_ERROR =
      new SFD_Status( "E_SFD_GEN_ERROR", 0, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_INIT_FAIL =
      new SFD_Status( "E_SFD_INIT_FAIL", 1, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_SHUTDOWN_ERROR =
      new SFD_Status( "E_SFD_SHUTDOWN_ERROR", 2, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_TIMER_SETUP_ERR =
      new SFD_Status( "E_SFD_TIMER_SETUP_ERR", 3, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_TIMER_CLOSE_ERR =
      new SFD_Status( "E_SFD_TIMER_CLOSE_ERR", 4, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_INVALID_STATE =
      new SFD_Status( "E_SFD_INVALID_STATE", 5, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_SERVER_NOT_FOUND =
      new SFD_Status( "E_SFD_SERVER_NOT_FOUND", 6, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_SEND_FAIL =
      new SFD_Status( "E_SFD_SEND_FAIL", 7, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_INVALID_COMMAND =
      new SFD_Status( "E_SFD_INVALID_COMMAND", 8, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_OID_CONFIG_ERR =
      new SFD_Status( "E_SFD_OID_CONFIG_ERR", 9, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_RECEIVE_ERR =
      new SFD_Status( "E_SFD_RECEIVE_ERR", 10, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_HOME_ERR =
      new SFD_Status( "E_SFD_HOME_ERR", 11, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_MOVE_ERR =
      new SFD_Status( "E_SFD_MOVE_ERR", 12, TTL_Package.E_SFD );

  /**
   * 
   */
  public final static SFD_Status E_SFD_STOPPED =
      new SFD_Status( "E_SFD_STOPPED", 13, TTL_Package.E_SFD );
