...
//-----------------------------------------------------------------------
//
//      Copyright (C) 1997 United Electronic Industries, Inc.
//      All rights reserved.
...
#define PD_SUBSYSTEMID_LAST       0x150     // Last valid PowerDAQ model
#define ADAPTER_AUTOCAL           0x0100    // Boards with autocalibration type 1
#define PD_AIB_SELMODE0           0x01FE    // Firmware mode0 logic support
#define PD_IS_MFX(id)   ((id>=0x101)&&(id<=0x14A))
#define PD_IS_MFS(id)   ((id>=0x12D)&&(id<=0x14A))
#define PD_IS_AO(id)    ((id>=0x14E)&&(id<=0x150))
//-----------------------------------------------------------------------
...
#define PD_AOUT_LAST    PD_AOPUTBLOCK
...
#define PD_DORESET      PD_DOUT_BASE+2  // DOut Reset to default
#define PD_DOUT_LAST    PD_DORESET
...
#define PD_DIO256_LAST  PD_DININTRREENABLE
...
#define AIB_BMDoneIm    (1L<<5)  // AIn Bus Master Blocks Transferred Int mask
...
#define AIB_BMDoneSC    (1L<<13) // AIn Bus Master Blocks Transferred Status/Clear
#define AIB_BMErrSC     (1L<<14) // Bus Master Data Transfer Error Status/Clear
#define AIB_BMEmptySC   (1L<<15) // Bus Master PRD Table Empty Error Status/Clear
//----------------------------------
// Status only bits:
...
#define AOB_EXTCVS      (1L<<2)  // AOut External Conv (Pacer) Clock Edge
#define AOB_DACBLK0     (1L<<3)  // DACs Enabled in Block Mode (4 bits)
#define AOB_DACBLK1     (1L<<4)
#define AOB_DACBLK2     (1L<<5)
#define AOB_DACBLK3     (1L<<6)
...
#define AOB_BUFMODE0    (1L<<11) // AOut Buf Mode (Single-Value/Block) (2 bits)
#define AOB_BUFMODE1    (1L<<12)
...
//-----------------------------------------------------------------------
#define DIO_REG0    0xFFFF00       // DIO 16 I/O Register 0 mask 
#define DIO_REG1    0xFFFF01       // DIO 16 I/O Register 1 mask
#define DIO_REG2    0xFFFF02       // DIO 16 I/O Register 2 mask
#define DIO_REG3    0xFFFF03       // DIO 16 I/O Register 3 mask
#define DIO_REG4    0xFFFF04       // DIO 16 I/O Register 4 mask 
#define DIO_REG5    0xFFFF05       // DIO 16 I/O Register 5 mask
#define DIO_REG6    0xFFFF06       // DIO 16 I/O Register 6 mask
#define DIO_REG7    0xFFFF07       // DIO 16 I/O Register 7 mask

#define DIO_SRD     0x000000       // Read register command 
#define DIO_SWR     0x000000       // Write register command 
#define DIO_LRD     0xFFFF08       // Read latch command
#define DIO_LWR     0xFFFF08       // Write latch enable command 
#define DIO_PWR     0xFFFF20       // Write propagate mask command 
#define DIO_LAL     0xFFFF40       // Latch all registers command 
#define DIO_LAR     0x000060       // Latch and read register command 
#define DIO_WOE     0xFFFF60       // Write output enable state command 

#define DIO_DIS_0_3 0xFFFF7B      // Disable reg 0 to 3 outputs
#define DIO_DIS_4_7 0xFFFF7F      // Disable reg 4 to 7 outputs

//-----------------------------------------------------------------------
// AO 32 Subsystem Configuration (AO32) Bits
//-----------------------------------------------------------------------
#define AO32_WRPR       0x0       // Write value to the DAC and set it
#define AO32_WRH        0x20      // Write value to the DAC but hold it
#define AO32_UPDALL     0x20      // Read to update all holded DACs
#define AO32_SETUPDMD   0x40      // Read to set last channel autoupdate
#define AO32_BASE       0xFFFF00  // Base address
