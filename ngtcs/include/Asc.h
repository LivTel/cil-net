...
**
** Version:
**    $Id: Asc.h,v 0.4 2001/02/01 09:56:50 jdm Exp $
**
** History:
**    $Log: Asc.h,v $
...
#define E_ASC_REG_SERVER_NAME   "E_TTL_ASC_Asc"
#define E_ASC_SERVER_PROC       "Asc"
#define E_ASC_SERVER_PATH       "//1/opt/ttl/bin/Asc"
#define E_ASC_SERVER_PRI        10
