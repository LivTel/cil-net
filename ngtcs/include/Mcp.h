...
**
** Version:
**    $Id: Mcp.h,v 0.40 2002/03/25 13:33:11 mjf Exp $
**
** History:
**    $Log: Mcp.h,v $
...
typedef enum ePmmStatus_e
{
   ...
   E_PMM_ERR_START_OBSERVATION,        /* Unable to execute start observation request */
...
static char eMcpSysReqIndexName[ E_MCP_SYSREQ_EOL ][ E_MCP_STRING_LEN ] = 
{
   ...
   "Full System Restart",
   "Shutdown on Failure Override",
   "Cancel Shutdown on Failure Override",
   "Observation Time Override",
   "Cancel Observation Time Override",
   ...
   "Cancel Stop Observation",
   "Refresh Start/Stop Observation Items",
