  ...
  implements java.io.Serializable, ngat.ngtcs.subsystem.TTL_DataType
{
  ...
  public final static SPT_State E_SPT_DISABLE =
      new SPT_State( "E_SPT_DISABLE", 0, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_ENABLE =
      new SPT_State( "E_SPT_ENABLE", 1, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_ANALOG =
      new SPT_State( "E_SPT_DMD_ANALOG", 2, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STOP =
      new SPT_State( "E_SPT_DMD_STOP", 3, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_INVALID =
      new SPT_State( "E_SPT_DMD_STS_INVALID", 4, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_ACTD =
      new SPT_State( "E_SPT_DMD_STS_ACTD", 5, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_SAFE =
      new SPT_State( "E_SPT_DMD_STS_SAFE", 6, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_ON =
      new SPT_State( "E_SPT_DMD_STS_ON", 7, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_OFF =
      new SPT_State( "E_SPT_DMD_STS_OFF", 8, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_START =
      new SPT_State( "E_SPT_DMD_STS_START", 9, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_STOP =
      new SPT_State( "E_SPT_DMD_STS_STOP", 10, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_OPN =
      new SPT_State( "E_SPT_DMD_STS_OPN", 11, TTL_Package.E_SPT );

  /**
   * 
   */
  public final static SPT_State E_SPT_DMD_STS_CLS =
      new SPT_State( "E_SPT_DMD_STS_CLS", 12, TTL_Package.E_SPT );

  /**
   * Reset
   */
  public final static SPT_State E_SPT_DMD_STS_RESET =
      new SPT_State( "E_SPT_DMD_STS_RESET", 13, TTL_Package.E_SPT );
