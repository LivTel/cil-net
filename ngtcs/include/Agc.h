...
**                                                                           
** Version:
**    $Id: Agc.h,v 0.6 2002/10/10 10:00:59 man Exp $
**
** History:
**    $Log: Agc.h,v $
...
int msiCalibrate(double *,double *,double *,double *,int,int,int,int,double *,double *);
...
int msiResetFIFO();
int msiBeginTimedReadout(MSI_IMAGE *, MSI_TIMED_READ_CALLBACK);
