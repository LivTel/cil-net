...
**
** Version:
**    $Id: Hhe.h,v 0.9 2002/03/22 12:08:32 mjf Exp $
**
** History:
**    $Log: Hhe.h,v $
...
HHE_EXTERN const char eHheDriverIdentification[] HHE_INIT({"TTL HHE QNX Driver Version 0.13"});
...
typedef enum{
    ...
    E_HHE_AUX_ENCODER_1,                    /* Length Encoder - development   */
    E_HHE_AUX_ENCODER_2,                    /* Length Encoder - development   */
    E_HHE_AUX_ENCODER_3,                    /* Length Encoder - development   */
    E_HHE_AUX_ENCODER_4,                    /* Length Encoder - development   */

    E_HHE_MAX_NUMBER_OF_ENCODERS            /* Used for range checking and determining */
                                            /* maximum number of cards */
}eHheEncoderID_t;

typedef enum{                               /* Heidenhain Card Parameter IDs */
...
Status_t eHheGetParameter (eHheEncoderID_t EncoderID, eHheParameterID_t ParameterID, Uint32_t *ParameterValue);
Status_t eHheGetAllParameters (eHheEncoderID_t EncoderID, eHheParameterSet_t *Parameters);
...
Status_t eHheGetLatchedCounterValues   
   (
      eHheLatch_t          LatchID, 
      Uint32_t             ConfiguredEncoderMask,
      eHhe48BitValue_t     *CounterValues,
      eHheEncoderState_t   *States,
      Uint32_t             *ReadSuccessMask
   );
